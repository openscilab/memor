...
- Run `pip install memor==1.2`
### Source code
- Download [Version 1.2](https://github.com/openscilab/memor/archive/v1.2.zip) or [Latest Source](https://github.com/openscilab/memor/archive/dev.zip)
- Run `pip install .`
...
| `disable_all_messages`                                            | Mark all the message as inactive (masked)                     |
...
| `to_dataframe`/`from_dataframe`                                   | Serialize or deserialize the session to/from Pandas DataFrame |
