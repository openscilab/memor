...
- Run `pip install memor==1.3`
### Source code
- Download [Version 1.3](https://github.com/openscilab/memor/archive/v1.3.zip) or [Latest Source](https://github.com/openscilab/memor/archive/dev.zip)
- Run `pip install .`
