...
INVALID_PATH_MESSAGE = "Invalid path: must be a string and refer to an existing location. Given path: {0}"
...
INVALID_INT_OR_STR_MESSAGE = "Invalid value. `{0}` must be an integer or a string."
INVALID_INT_OR_STR_SLICE_MESSAGE = "Invalid value. `{0}` must be an integer, string or a slice."
