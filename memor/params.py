...
INVALID_INT_VALUE_MESSAGE = "Invalid value. `{parameter_name}` must be an integer."
INVALID_NON_NEGATIVE_FLOAT_VALUE_MESSAGE = "Invalid value. `{parameter_name}` must be a non-negative number."
INVALID_NON_NEGATIVE_INT_VALUE_MESSAGE = "Invalid value. `{parameter_name}` must be a non-negative integer."
