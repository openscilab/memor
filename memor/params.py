...
INVALID_NON_NEGATIVE_FLOAT_VALUE_MESSAGE = "Invalid value. `{parameter_name}` must be zero or a positive number."
INVALID_NON_NEGATIVE_INT_VALUE_MESSAGE = "Invalid value. `{parameter_name}` must be zero or a positive integer."
