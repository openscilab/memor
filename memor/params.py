...
class LLMModel(Enum):
    ...
    PHI_3_SMALL_128K_INSTRUCT = "phi-3-small-128k-instruct"
    PHI_3_MEDIUM_4K_INSTRUCT = "phi-3-medium-4k-instruct"
    PHI_3_MEDIUM_128K_INSTRUCT = "phi-3-medium-128k-instruct"
    PHI_3_VISION_128K_INSTRUCT = "phi-3-vision-128k-instruct"
    ...
    BITNET_B_1_58_2B_4T = "bitnet-b1.58-2b-4t"
    MAI_DS_R1 = "mai-ds-r1"
    MEDIPHI = "mediphi"
    ...
    UDOP_LARGE_300K = "udop-large-300k"
    FLORANCE_2_BASE = "florance-2-base"
    FLORANCE_2_LARGE = "florance-2-large"
    LLAMA_2_GTL_DELTA_7B = "llama-2-7b-gtl-delta"
    LLAMA_2_GTL_DELTA_13B = "llama-2-13b-gtl-delta"
