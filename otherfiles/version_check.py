...
SETUP_ITEMS = [
    "version='{0}'",
    'https://github.com/openscilab/memor/tarball/v{0}']
README_ITEMS = [
    "[Version {0}](https://github.com/openscilab/memor/archive/v{0}.zip)",
    "pip install memor=={0}"]
CHANGELOG_ITEMS = [
    "## [{0}]",
    "https://github.com/openscilab/memor/compare/v{0}...dev",
    "[{0}]:"]
...
FILES = {
    ...
    os.path.join("memor", "params.py"): PARAMS_ITEMS,
    ...
    for file_name in FILES:
        try:
            ...
            for test_item in FILES[file_name]:
                if file_content.find(test_item.format(MEMOR_VERSION)) == -1:
